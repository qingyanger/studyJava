...
public class MpGenerator
{
     ...
     * </p>
     */
    public static void buildCode(GeneratorConfig config) {
        ...
        gc.setOutputDir(config.outputDir);
        ...
        strategy.setInclude("sys_quota_plan","sys_quota_plan_detail"); // 需要生成的表
        ...
        pc.setParent(config.parentPackage);
        pc.setModuleName("");
